...
def getOnlineModels():
    ...
    global wanted
    try:
        data = {'categories': ','.join(genders), 'num': 0}
...
if __name__ == '__main__':
    AllowedGenders = ['female', 'male', 'trans', 'couple', 'f', 'm', 't', 'c']
    for gender in genders:
        if gender.lower() not in AllowedGenders:
            print(gender, "is not an acceptable gender, options are: female, f, male, m, trans, t, couple anc c - please correct your config file")
            exit()
